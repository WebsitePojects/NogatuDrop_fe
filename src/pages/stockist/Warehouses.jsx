...
export default function StockistWarehouses() {
  ...
  return (
    <div className="page-enter">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4">
          {warehouses.map((wh) => {
            ...
            return (
              <div
                key={wh.id}
                className="bg-white dark:bg-[var(--dark-card)] rounded-xl border border-coffee-100 dark:border-[var(--dark-border)] p-5 cursor-pointer hover:shadow-card-hover hover:-translate-y-0.5 transition-all"
      ...
      {/* Detail Modal */}
      <Modal show={viewModal} onClose={() => setViewModal(false)} size="2xl" backdropClasses="bg-black/50 backdrop-blur-sm">
        <ModalHeader>
                ...
                <div className="overflow-x-auto border border-gray-100 dark:border-[var(--dark-border)] rounded-lg">
                  <table className="w-full text-sm">
                    <thead className="bg-coffee-50 dark:bg-[var(--dark-card)]">
                      <tr className="text-xs text-coffee-700 dark:text-[var(--dark-muted)] uppercase">
