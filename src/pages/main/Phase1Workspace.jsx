...
export default function MainPhase1Workspace({ pageKey }) {
  ...
  return (
    <div className="space-y-5 page-enter">
      ...
      <div className="workspace-summary-band p-5 sm:p-6 dark:bg-[linear-gradient(135deg,#271c18_0%,#221814_100%)]">
        <div className="flex flex-col gap-4 md:flex-row md:items-start md:justify-between">
          <div className="space-y-2">
            <div className="flex items-center gap-2">
              <span className="brand-chip brand-chip--warm">{page.tab}</span>
          ...
          <div className="flex h-12 w-12 items-center justify-center rounded-xl bg-amber-100 text-amber-600 shadow-[inset_0_1px_0_rgba(255,255,255,0.65)]">
        ...
        <div className="workspace-split-panel xl:col-span-2 p-5">
          ...
          {state.loading ? (
            ...
            <DataTable
              ...
              renderRow={(row, idx) => (
                <tr key={row.id || `${row.reason || 'row'}-${idx}`}>
      ...
      {!state.loading && view.detailCard && resolvedKey === 'applications-review' && (
        <div className="workspace-split-panel p-5">
          <h3 className="mb-3 text-sm font-semibold text-gray-800 dark:text-[var(--dark-text)]">Focused Applicant Detail</h3>
